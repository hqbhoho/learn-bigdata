 ...
 * describe:
 * <p>
 * {@link com.hqbhoho.bigdata.learnFlink.table_sql.tableAPI.InsertOperationExample}
 *
 * @author hqbhoho
 * @version [v1.0]
 * @date 2019/06/05
...
public class InsertOperationExample {
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.registerTableSink("results",
                ...
                new CsvTableSink("E:\\javaProjects\\learn-bigdata\\learn-flink\\src\\main\\resources\\results1.csv"
                        , ",", 1, FileSystem.WriteMode.NO_OVERWRITE));

        tableEnv.sqlUpdate("insert into results select name,account from " + inputTable);
