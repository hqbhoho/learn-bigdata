 ...
 * @date 2020/04/24
 */
public class HiveDriver implements CommandProcessor {
     ...
     */
    public HiveDriver(HiveConf conf) {
        this(conf, new HooksLoader(conf));
    }

    public HiveDriver(HiveConf conf, String userName) {
    ...
    public HiveDriver(HiveConf conf, HooksLoader hooksLoader) {
        this(conf, null, hooksLoader, null);
    }

    public HiveDriver(HiveConf conf, String userName, QueryInfo queryInfo) {
        this(conf, userName, new HooksLoader(conf), queryInfo);
    }

    public HiveDriver(HiveConf conf, String userName, HooksLoader hooksLoader, QueryInfo queryInfo) {
        this.conf = conf;
    ...
    public int compile(String command, boolean resetTaskIds, boolean deferClose) {
        ...
        try {
            ...
            // TODO
            BaseSemanticAnalyzer sem = HiveSemanticAnalyzerFactory.get(conf, tree);
...
//            return 0;
    ...
    public int execute(boolean deferClose) throws CommandNeedRetryException {
        ...
        try {
            ...
            System.out.println(hookContext.getLinfo().entrySet());
            System.out.println("===============================");
//            System.out.println(queryInfo);
//            System.out.println("=============================");
//            System.out.println(hookContext.getLinfo());
//            System.out.println("=============================");
//            System.out.println(SessionState.get().getLineageState().getLineageInfo().entrySet());
//            System.out.println("=============================");
            ...
            for (Task<? extends Serializable> tsk : plan.getRootTasks()) {
                ...
                Task<? extends Serializable> temp = tsk;
            ...
            while (driverCxt.isRunning()) {
                ...
                System.out.println("driverCxt ："+ tskRun.getTask());
                if (tskRun == null) {
                    continue;
                }
...
//                            if(child instanceof MoveTask){
//                                child = new MoveTask();
//                                child.initialize(conf,getPlan(),driverCxt);
//                            }
...
//        tskRes.setRunning(false);
        ...
        if (HiveConf.getBoolVar(conf, HiveConf.ConfVars.EXECPARALLEL) && tsk.isMapRedTask()) {
            ...
            tskRun.start();
            /*if(tskRun.getTask() instanceof MoveTask){
                System.out.println(tskRun.getTask());
                tskRun.start();
            }else{
...
//            tskRun.runSequential();
            ...
            System.out.println(tskRun.getTask());
            if(tskRun.getTask() instanceof ExecDriver || tskRun.getTask() instanceof MapredLocalTask || tskRun.getTask() instanceof StatsTask){
                tskRun.getTaskResult().setExitVal(0,null);
                tskRun.getTaskResult().setRunning(false);
