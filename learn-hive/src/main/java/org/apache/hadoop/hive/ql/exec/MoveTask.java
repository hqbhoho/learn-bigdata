...
public class MoveTask extends Task<MoveWork> implements Serializable {
    ...
    public int execute(DriverContext driverContext) {
        ...
        try {
            // todo 2020-05-19  MoveTask  跳过文件移动的动作
            LOG.info("Lineage Analyzer don't execute moveTask,only get lineage...");
...
//            tbd.setPartitionSpec(new HashMap<>());
            if (tbd != null) {
                ...
                /*if (tbd.getPartitionSpec().size() == 0) {
                    ...
                    *//*db.loadTable(tbd.getSourcePath(), tbd.getTable()
                    ...
                    if (dpCtx != null && dpCtx.getNumDPCols() > 0) { // dynamic partitions
                        ...
                        Map<Map<String, String>, Partition> dp = new HashMap<>();
